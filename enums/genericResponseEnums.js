const GENERIC_RESPONSE_MESSAGES = {
  ...
  MOBILE_OR_PASSWORD_NOT_MATCHINF: "Not matching mobile or password ",
  FIRST_NAME_REQUIRED: "First name is required",
  DOB: "Date of birth is required",
  MOBILE_IS_REQUIRED: "Mobile number is required",
  PASS_CONFIRMPASS_NOT_MATCHING: "Password and confirmation do not match. ",
  PASSWORD_IS_REQUIRED: "Password is required",
  CONFIRM_PASS_IS_REQUIRED: "Confirm password is required",
  MOBILE_IN_10_DIGIT: "Mobile number should have 10 digits.",
  USER_ALREDY_EXIST: "User alredy exist",
  TOKEN_NOT_INSERTED: "Token was not entered into the database. ",
  OTP_NOT_MATCHING: "OTP not matching",
  OTP_USER_NOT_FOUND: "OTP was not found. ",
  OTP_REQUIRED: "Otp is required",
  USER_VERIFIED: "The user has now been verified. ",
  USER_NOT_FOUND: "User not found; please register now. ",
  ...
  CATEGORY_CREATION_FAILED: "The shop category could not be created.",
  CATEGORY_ALREADY_CREATED: "Category name ${name} is already created",
  CATEGORY_Id_REQUIRED: "Category ID is required",
  CATEGORY_NOT_FOUND: "Category not found",
  CATEGORY_UPDATED: "Category Update was completed successfully.",
  CATEGORY_DELETED: "Category deleted successfully",
  SIGNIN_SUCESS: "Successfully logged in. ",
  ...
  SHOP_NOT_FOUND: "Shops could not be found; please try again later. ",
  SHOP_CREATED_SUCCESSFULY: "Shop was successfully created. ",
  DELETE_SHOP_SUCCESS: "shop was successfully deleted.",
  SHOP_SUCCESS_VARIFIED: "Shop was successfully verified.",
  ...
  PRODUCT_CREATED_SUCCESSFULY: "Product successfully created ",
